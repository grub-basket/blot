...
var MESSAGES = [
  ...
  "BILLING_INTERVAL",
  "CANCELLED",
  "CANCELLED_FIRST_PERIOD",
  "CLOSED",
  "DELETED_FIRST_PERIOD",
  "CREATED_BLOG",
  "DAILY_UPDATE",
  "DELETED",
  "DELETED_CANCELLED_SUBSCRIPTION_EXPIRED",
  "DISABLED",
  "DROPBOX_SYNC_ISSUE",
  "GOOGLE_DRIVE_SERVICE_ACCOUNT_LOW",
  "ICLOUD_SYNC_ISSUE",
  "ICLOUD_APPROACHING_DISK_LIMIT",
  "ICLOUD_DISK_LIMIT",
  "ICLOUD_APPROACHING_QUOTA_LIMIT",
  "ICLOUD_QUOTA_LIMIT",
  "ICLOUD_RESYNC_REQUESTED",
  "ICLOUD_SERVER_STARTED",
  "ICLOUD_SERVER_DOWN",
  "ICLOUD_SERVER_RECOVERED",
  "ICLOUD_SERVER_PANIC",
  "LONG_DELAY",
  "LONG_SYNC",
  "NETWORK_ERROR",
  ...
  "OVERDUE",
  "OVERDUE_CLOSURE",
  "OVERDUE_SUBSCRIPTION_DELETION_FLOW",
  "OVERDUE_SUBSCRIPTION_DISABLED_GRACE",
  "OVERDUE_SUBSCRIPTION_GRACE_ACTIVE",
  "QUESTION",
  "QUESTION_PUBLISHED",
  "QUESTION_REPLY_PUBLISHED",
  "RATE_LIMIT",
  "RESTART",
  "RECOVERED",
  "REVOKED",
  ...
  "SYNC_REPORT",
  "UPCOMING_RENEWAL",
  "UPCOMING_MONTHLY_FIRST_RENEWAL",
  "UPCOMING_EXPIRY",
  "UPDATE_BILLING",
